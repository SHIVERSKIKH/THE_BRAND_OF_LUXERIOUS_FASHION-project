import { productsMans } from "./productsMan.js";
...
const productData = JSON.parse(productsMans);
    ...
    <li data-id="${id}" class="product__item">
        <div class="product__content-item">
            <div class="product__content-img">
               <a class="product__item-link" href="product.html">
               <img class="product__item-photo" src="${image}" alt="${image}" height="420"></a> 
            </div>
            <div class="product__content-info"><h3 class="product__content-title">${name}</h3>
                <p class="product__content-txt">${description}</p>
                <p class="product__price">$${price}</p></div>
                <button data-cart class="product__item-btn txt" type="button">
